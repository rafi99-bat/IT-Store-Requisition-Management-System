...
insert into Admin (Email, Password) values ('admin123@gmail.com', '123456');

create table Users
(
Branch varchar(30) primary key not null,
Password varchar(32) not null,
...
Date date not null,
Branch varchar(30) not null foreign key  references Users(Branch)
);
